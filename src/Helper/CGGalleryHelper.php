...
class CGGalleryHelper
{
    ...
    public static function getArticleInfos($id)
    {
    ...
    public static function getCatAlias($id)
    {
        $db = Factory::getContainer()->get(DatabaseInterface::class);
        $query = $db->getQuery(true)
            ->select('alias')
    ...
    public static function getArticle(&$item, $params)
    {
